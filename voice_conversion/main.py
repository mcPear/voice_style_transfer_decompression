...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset_path', default="/tf/notebooks/SKAJPAI/voice_style_transfer/voice_conversion/vctk_old/data.h5")
    parser.add_argument('-index_path', default="/tf/notebooks/SKAJPAI/voice_style_transfer/voice_conversion/vctk_old/index.json")
